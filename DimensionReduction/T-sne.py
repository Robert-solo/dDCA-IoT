...
def tsne(x, no_dims=2, initial_dims=50, perplexity=30.0, max_iter=1000):
    ...
    return y
def eval_model(data, target, label):
    '''
    模型评估
    :param data:
    :param target:
